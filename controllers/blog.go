...
// blog pages are described by comment-layout.html
// 	{{.Header}}
// 	{{.LayoutContent}}
// 	{{.Footer}}
// Note {{.LayoutContent}} is replaced by template content as specified by view
func (bc *BlogController) activeContent(view string) {
	bc.Layout = "comment-layout.html"
	bc.LayoutSections = make(map[string]string)
	bc.LayoutSections["Header"] = "header.html"
	bc.LayoutSections["Footer"] = "footer.html"
	bc.TplName = view + ".html"
